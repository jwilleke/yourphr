...
func (s *FhirRelatedPerson) PopulateAndExtractSearchParameters(resourceRaw json.RawMessage) error {
	...
	// extracting Active
	activeResult, err := vm.RunString("extractTokenSearchParameters(fhirResource, 'RelatedPerson.active')")
	...
	identifierResult, err := vm.RunString("extractTokenSearchParameters(fhirResource, 'RelatedPerson.identifier')")
	...
	relationshipResult, err := vm.RunString("extractTokenSearchParameters(fhirResource, 'RelatedPerson.relationship')")
