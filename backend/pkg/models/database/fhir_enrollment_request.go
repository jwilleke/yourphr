...
func (s *FhirEnrollmentRequest) PopulateAndExtractSearchParameters(resourceRaw json.RawMessage) error {
	...
	identifierResult, err := vm.RunString("extractTokenSearchParameters(fhirResource, 'EnrollmentRequest.identifier')")
	...
	// extracting Status
	statusResult, err := vm.RunString("extractTokenSearchParameters(fhirResource, 'EnrollmentRequest.status')")
	if err == nil && statusResult.String() != "undefined" {
		s.Status = []byte(statusResult.String())
	}
	// extracting Subject
	subjectResult, err := vm.RunString("extractReferenceSearchParameters(fhirResource, 'EnrollmentRequest.candidate')")
