...
// ListAllResources mocks base method.
func (m *MockDatabaseRepository) ListAllResources(ctx context.Context, queryOptions models.ListResourceQueryOptions) ([]models.ResourceBase, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListAllResources", ctx, queryOptions)
	ret0, _ := ret[0].([]models.ResourceBase)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListAllResources indicates an expected call of ListAllResources.
func (mr *MockDatabaseRepositoryMockRecorder) ListAllResources(ctx, queryOptions interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListAllResources", reflect.TypeOf((*MockDatabaseRepository)(nil).ListAllResources), ctx, queryOptions)
}
