...
export class TypesenseService {
  ...
  constructor(private settingsService: SettingsService) {
    ...
    if (searchSettings?.enabled) {
      ...
      // search.enabled is false by default — this is the normal state for a stock install,
      // not an error.
      console.debug("Search is disabled for this instance, skipping Typesense client setup");
    }
  }
